...
ui <- fluidPage(
  ...
  tabPanel(
    ...
    sidebarLayout(
      ...
      mainPanel(
        h4(div("Explore the maps below by", strong("zooming in and out"), "and", strong("hover and click"), "to find out more information for a given geography.", style = "color: grey;")),
        
        fluidRow(
          splitLayout(cellWidths = c("50%", "50%"), h4(div(strong("Cluster Map"), style = "color: grey")), h4(div(strong("Descriptive Map of ASIRs"), style = "color: grey")))),
        fluidRow(
          splitLayout(cellWidths = c("50%", "50%"), tmapOutput("cluster_map", height = 500), tmapOutput("asir_map", height = 500))),
        strong("Notes:"),
        div("Data are", strong("synthetic"), "(i.e. fake data) and do not represent actual rates", style = "color: grey;"),
        div("ASIR = Age-standardized incidence rate", style = "color: grey;"),
        div("Rates were age-standardized using the direct method to the 2011 Canadian Census Age Structure", style = "color: grey;"),
        ...
        br(),
        fluidRow(
          splitLayout(cellWidths = c("50%", "50%"), plotOutput("moran_plot"), plotlyOutput("lisa_plot"))),
        br(),
  ...
  #     sliderInput("year_var2", "Year", min = 2014, max = 2017, value = 2017)),
    mainPanel(
      h4(div("Under development...", style = "color: grey;"))
